...
- Getting SSL on these!
   > using cert-manager.io seems to be the best fastest way. To test things out locally, follow instructions on `local-k8/ssl/readme.md`
   ![](assets/image/ssl.png)
- HELM
...
- Setting **SLO**, identify **SLIs** in service to those SLOs.
